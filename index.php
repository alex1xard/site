...
define('CAMPAIGN_ID', "258bc2e0558a20e6d85d267fa343a9e7");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', 'b4df91ffe0ce5ab4719301bfaee14146');
define('MP_PARAM_NAME', '__tkclk');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', 'a85639c0b0da3e8927b0ace8239fe51c');
define('CHECK_MCPROXY_VALUE', '8fcf05dd373a4a98a7f65e317d4739c90bcf2d426ebf9faa425319cb654e7ece');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '7278.3');
